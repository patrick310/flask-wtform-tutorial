        ...
        # if file selected and is a json file
            ...
            if not os.path.isfile(os.path.join(SURVEY_DIRECTORY, filename)):
                ...
                try: 
                    ...
                    survey = json.load(f)
                    print("survey loaded from temp and ready to check")
                    f.close()
...
def admin():
    ...
    for file in os.listdir(SURVEY_DIRECTORY):
        ...
        try:
            ...
            print("Successfully appended " + get_survey_title(file) + " to the admin set")
        except OSError or IOError as e:
            print(e)
            print("Missed adding a survey for a reason")
    return render_template(
        "admin.jinja2",
